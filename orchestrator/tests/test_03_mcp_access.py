        ...
        async for message in query(
            ...
            if hasattr(message, 'result'):
                ...
                if "playwright" in result.lower():
                    ...
                    print(f"  ✅ Playwright MCP tools detected!")

        print()
        if playwright_found:
            print(f"✅ SUCCESS: MCP tools (including Playwright) are accessible")
        else:
            print(f"⚠️  WARNING: Playwright not explicitly mentioned")
            print(f"   This might mean MCP tools need different configuration")
