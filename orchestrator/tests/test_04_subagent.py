        ...
        async for message in query(
            ...
            if hasattr(message, "result"):
                ...
                if "TEST AGENT WORKING" in result:
                    ...
                    print(f"  ✅ Subagent invoked successfully!")

        print()
        if subagent_worked:
            print(f"✅ SUCCESS: Subagent invocation working")
        else:
            print(f"⚠️  WARNING: Subagent response not as expected")
            print(f"   Subagents might work differently than expected")
